...
public class C02_ExplicitlyWait {
    ...
    public void explicitWaitTest() {
        ...
        // ExplicitliWait icin once wait objesi olusturalim

        WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(30));

        //bundan sonraki adimi belirlerken
        // islem yapmak istediginiz locate edilebilir olup olmadigi onemlidir
        // eger locate edilebilirse,once locat edip, sonra
        // wait objesi ile o web element bekletilebilir

        // locate edilemiyorsa, wait objesine bekleme emri
        // locator olarak verilebilir
