...
public class C03_WindowHandle {
   ...
   // yeni tab'a gecip sayfadaki en buyuk yazinin  "Elemental Selenium" oldugunu test edin
        // click yapilinca yeni tab acilir ancak driver eski tab'da kalir
        // yeni tab'a driver'i gecirmek icin yeni tabin WHD ihtiyacimiz var
       ...
       // foreach loop bittiginde, ikinci sayfanin WHD'i elde etmis olacagiz
