...
public class C04_IFrame {
    ...
    // - TextBox’in altinda bulunan “Elemental Selenium” linkini gorunur oldugunu dogrulayin ve  konsolda yazdirin.
      ...
      driver.switchTo().defaultContent(); // anasayfaya gecis yapr
